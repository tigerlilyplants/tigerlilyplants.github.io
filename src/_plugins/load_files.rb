...
module Jekyll
  # Loop over a directory by file extension.
  class LoopDirectoryTag < Liquid::Block
    ...
    def initialize(tag_name, markup, tokens)
      ...
      # Parse parameters
      raise SyntaxError, "Bad options given to 'loop_directory' plugin." if markup !~ SYNTAX
    ...
    def render(context)
      ...
      if @attributes['sort'].casecmp('descending').zero?
